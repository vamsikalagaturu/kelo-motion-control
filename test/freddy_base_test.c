...
int main(int argc, char *argv[])
{
  ...
  init_kelo_base_config(&kelo_base_config, radius, castor_offset, half_wheel_distance,
  ...
  {
    usleep(10000);
    compute_wheel_torques(&kelo_base_config, &torque_control_state, pivot_angles, wheel_torques, N, M);
    rxpdo1_t rx_msg;
